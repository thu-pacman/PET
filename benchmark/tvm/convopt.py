...
W = te.placeholder((kernel_height, kernel_width, in_channel, out_channel), name='W')
...
w_np = np.random.uniform(size=(kernel_height, kernel_width, in_channel, out_channel)).astype(W.dtype)
