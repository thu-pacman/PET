...
cudnnTensorFormat_t KERNEL_TENSOR_FORMAT = CUDNN_TENSOR_NHWC;
...
void get_args(int argc, const char *argv[]) {
    int pos = 1;
    while (pos < argc) {
        if (pos + 1 < argc && !strcmp(argv[pos], "-gc") &&
            isdigit(argv[pos + 1])) {
        ...
        if (pos + 1 < argc && !strcmp(argv[pos], "-bs") &&
            isdigit(argv[pos + 1])) {
        ...
        if (pos + 1 < argc && !strcmp(argv[pos], "-kernels") &&
            isdigit(argv[pos + 1])) {
        ...
        if (pos + 1 < argc && !strcmp(argv[pos], "-inh") &&
            isdigit(argv[pos + 1])) {
            INPUT_HEIGHT = atoi(argv[pos + 1]);
            pos += 2;
            continue;
        }
        if (pos + 1 < argc && !strcmp(argv[pos], "-inw") &&
            isdigit(argv[pos + 1])) {
        ...
        if (pos + 1 < argc && !strcmp(argv[pos], "-kerh") &&
            isdigit(argv[pos + 1])) {
            KERNEL_HEIGHT = atoi(argv[pos + 1]);
            pos += 2;
            continue;
        }
        if (pos + 1 < argc && !strcmp(argv[pos], "-kerw") &&
            isdigit(argv[pos + 1])) {
        ...
        if (pos + 1 < argc && !strcmp(argv[pos], "-padh") &&
            isdigit(argv[pos + 1])) {
            PAD_HEIGHT = atoi(argv[pos + 1]);
            pos += 2;
            continue;
        }
        if (pos + 1 < argc && !strcmp(argv[pos], "-padw") &&
            isdigit(argv[pos + 1])) {
            PAD_WIDTH = atoi(argv[pos + 1]);
            pos += 2;
            continue;
        ...
        if (pos + 1 < argc && !strcmp(argv[pos], "-dilateh") &&
            isdigit(argv[pos + 1])) {
            DILATION_HEIGHT = atoi(argv[pos + 1]);
            pos += 2;
            continue;
        }
        if (pos + 1 < argc && !strcmp(argv[pos], "-dilatew") &&
            isdigit(argv[pos + 1])) {
        ...
        if (pos + 1 < argc && !strcmp(argv[pos], "-strideh") &&
            isdigit(argv[pos + 1])) {
            VERTICAL_STRIDE = atoi(argv[pos + 1]);
            pos += 2;
            continue;
        }
        if (pos + 1 < argc && !strcmp(argv[pos], "-stridew") &&
            isdigit(argv[pos + 1])) {
...
int main(int argc, const char *argv[]) {
    ...
    double time_conv = 0.0, time_conv_total = 0.0, time_total = 0.0,
           time_choose = 0.0;
    ...
    for (int kk = 0; kk < 3; ++kk) {
        ...
        for (int i = 0; i < expr; ++i) {
            ...
            time_conv_total += get_durtime(t1, t2);
            time_conv +=
