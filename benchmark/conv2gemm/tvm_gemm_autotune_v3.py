...
@autotvm.template('gemm-autotune/gemm_v3')
def gemm_autotune(mm, nn, ll, dtype='float32'):
    ...
    cfg.define_knob('tile_partsx', [1, 2, 4, 8])
    cfg.define_knob('tile_partsy', [1, 2, 4, 8])
    cfg.define_knob('tile_num_threadx', [1, 2, 4, 8, 16, 32])
    cfg.define_knob('tile_num_thready', [1, 2, 4, 8, 16, 32])
    cfg.define_knob('tile_num_blockx', [1, 2, 4, 8, 16, 32])
    cfg.define_knob('tile_num_blocky', [1, 2, 4, 8, 16, 32])
    # scale = 8
    # num_thread = 8
...
def test_gemm(mm, nn, ll):
    ...
    task = autotvm.task.create('gemm-autotune/gemm_v3',
