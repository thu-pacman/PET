...
namespace tpm {
template <typename MutatorT> class SearchEngine {
private:
  ...
  std::shared_ptr<MutatorT> mutationEngine;
...
public:
  ...
  double getPerf(const std::shared_ptr<SubGraph> &graph, bool profiling = false,
