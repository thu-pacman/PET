...
input_tasks = [  # Input, Kernel, p, s, d
    # Conv-1	-, 64, 56, 56	64, 64, 3, 3
    [[1, 64, 56, 56],  [64, 64, 3, 3], [1, 1], [1, 1], [1, 1]],
    [[4, 64, 56, 56],  [64, 64, 3, 3], [1, 1], [1, 1], [1, 1]],
    [[16, 64, 56, 56], [64, 64, 3, 3], [1, 1], [1, 1], [1, 1]],
    [[64, 64, 56, 56], [64, 64, 3, 3], [1, 1], [1, 1], [1, 1]],
    # Conv-7, d=2	-, 512, 14, 14	256, 512, 3, 3
    [[1, 512, 14, 14],  [256, 512, 3, 3],  [2, 2], [1, 1], [2, 2]],
    [[4, 512, 14, 14],  [256, 512, 3, 3],  [2, 2], [1, 1], [2, 2]],
    [[16, 512,  14, 14], [256, 512, 3, 3], [2, 2], [1, 1], [2, 2]],
    [[64, 512,  14, 14], [256, 512, 3, 3], [2, 2], [1, 1], [2, 2]],
]
